...
class Router():
    ...
    """
        ФУНКЦИЯ выводит базовые настройки ввиде таблицы
    """
    ...
    """
    def show_network_cfg(self, device, command_sh_net):
...
if __name__ == "__main__":
    with open("BM10_LTE.yaml")as f:
         ...
         for t in temp:
            ...
            # print (r1.base_cfg(device, r1.commands_802_1d_cfg))           # Cfg for 802d
